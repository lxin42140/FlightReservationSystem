...
//    
//
//    public void flightPlanningMenu(String accessRight) {
//
//        if (accessRight.equals("FLEETMANAGER")) {
//            aircraftConfigurationMenu();
//        } else if (accessRight.equals("ROUTEPLANNER")) {
//            flightRouteMenu();
//        }
//    }
//
...
//
//        aircraftConfiguration.setNumberOfCabins(numCabinClasses);
//
...
//        }
//        try {
//            aircraftConfigurationSessionBeanRemote.createNewAircraftConfiguration(aircraftConfiguration, cabinConfigurations, aircraftTypeId);
...
//
//        do {
//            System.out.println("Do you want to create a complementary return flight route? (Y/N)>");
